...
-- tarsAdminRegistry
replace into `t_adapter_conf` (`application`, `server_name`, `node_name`, `adapter_name`,`registry_timestamp`, `thread_num`, `endpoint`, `max_connections`, `allow_ip`, `servant`, `queuecap`, `queuetimeout`,`posttime`,`lastuser`,`protocol`, `handlegroup`) VALUES ('tars','tarsAdminRegistry','localip.tars.com','tars.tarsAdminRegistry.AdminRegObjAdapter',now(),5,'tcp -h localip.tars.com -t 60000 -p 12000',2000,'','tars.tarsAdminRegistry.AdminRegObj',12000,60000,now(),'admin','tars','');
