...
def do():
    ...
    doCmd("mysql -uroot -e 'drop database if exists db_tars'")
    doCmd("mysql -uroot -e 'drop database if exists tars_stat'")
    doCmd("mysql -uroot -e 'drop database if exists tars_property'")
    doCmd("mysql -uroot -e 'drop database if exists db_tars_web'")
